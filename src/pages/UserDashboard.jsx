                ...
                <div className="flex justify-center mt-7">
                    <div className="bg-white min-w-[700px] w-[1100px] h-[230px] border shadow-lg rounded-xl p-6 flex items-center">
                        ...
                        <div className="ml-5 flex flex-col">
                            ...
                            <div className=" text-[#6b7385]">
                                {staffdetails.length > 0 && staffdetails[0].department 
                                    ? `Department of ${staffdetails[0].department}` 
                                    : 'Department information not available'}
                            </div>
                            <div className=" text-[#6b7385] mt-1">
                                {staffdetails.length > 0 && staffdetails[0].email 
